...
$database_array_explode = explode('|', $value);
...
$img_url = $database_array_explode['3'];
  ...
  <p class='btngg2'>$harga_barang</p><p class='btngg3'>$nama_barang</p><a href='./delete.php?id=$data_barang_md5'><img width='50px' class='btnggdelete zoom' src='../requirement/delete.png'></a><a href='./edit-item.php?data=$data_barang_md5'><img width='50px' class='btnggedit zoom' src='../requirement/setting.png'></a></div></div></div> ";
